...
def run_mamm():
    ...
    plt.xlabel('Age')
    plt.ylabel('BI-RADS Score')
    plt.scatter(x=mamm_df.age, y=mamm_df.BI_RADS, c=color_theme[pred], s=5)
    plt.show()
...
def run_skin():
    ...
    ax2.set_zlabel("Red")
    ax2.scatter(xs=skin_df.blue, ys=skin_df.green, zs=skin_df.red, c=color_theme[pred], s=1)
    plt.show()
